export const INDIAN_STATES_DISTRICTS = {
  "Andhra Pradesh": [
    ...
    "Chittoor", "East Godavari", "Eluru", "Guntur", "Kakinada", "Kurnool", "NTR", 
    "Nandyal", "Nellore", "Palnadu", "Parvathipuram Manyam", "Prakasam", "Srikakulam", 
    "Sri Satya Sai", "Tirupati", "Visakhapatnam", "Vizianagaram", "West Godavari", "YSR Kadapa"
  ],
  "Arunachal Pradesh": [
  ...
  "Chhattisgarh": [
    ...
    "Raigarh", "Raipur", "Rajnandgaon", "Sarangarh-Bilaigarh", "Sakti", "Sukma", "Surajpur", "Surguja", "Khairagarh-Chhuikhadan-Gandai"
  ],
  ...
  "Maharashtra": [
    ...
    "Beed", "Bhandara", "Buldhana", "Chandrapur", "Dharashiv (Osmanabad)", "Dhule", 
  ...
  "Punjab": [
    ...
    "Sahibzada Ajit Singh Nagar (Mohali)", "Sangrur", "Shahid Bhagat Singh Nagar", "Sri Muktsar Sahib", "Tarn Taran"
  ],
  "Rajasthan": [
    "Ajmer", "Alwar", "Anupgarh", "Balotra", "Banswara", "Baran", "Barmer", "Beawer", 
    "Bharatpur", "Bhilwara", "Bikaner", "Bundi", "Chittorgarh", "Churu", "Dausa", 
    "Deeg", "Didwana-Kuchaman", "Dholpur", "Dungarpur", "Gangapur City", "Hanumangarh", 
    "Jaipur", "Jaipur Rural", "Jaisalmer", "Jalore", "Jhalawar", "Jhunjhunu", "Jodhpur", 
    "Jodhpur Rural", "Karauli", "Kota", "Kotputli-Behror", "Khairthal-Tijara", "Nagaur", 
...
export const getStates = () => Object.keys(INDIAN_STATES_DISTRICTS).sort();

export const getDistrictsForState = (stateName) => {
  if (!stateName || !INDIAN_STATES_DISTRICTS[stateName]) {
    return [];
  }
