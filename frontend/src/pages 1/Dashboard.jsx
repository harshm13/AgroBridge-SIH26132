...
export default function Dashboard() {
    const { userRole, t, farmerProfile } = useContext(AppContext);
                ...
                {simpleMode ? (
                    ...
                    >
                        <div className="bg-white rounded-3xl p-8 sm:p-12 text-center border-2 border-slate-200 shadow-xl relative overflow-hidden">
                            ...
                            <button className="w-full bg-slate-800 text-white font-black py-5 rounded-2xl text-xl shadow-lg hover:bg-slate-900 transition-all flex items-center justify-center gap-3">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
                            ...
                            <div className="ab-ai-card p-6 sm:p-8 flex flex-col h-full border-t-4 border-t-emerald-500">
                                <div className="flex justify-between items-start mb-8">
                                    ...
                                    <div className="bg-slate-100 px-3 py-1.5 rounded-lg border border-slate-200 flex items-center gap-2 cursor-pointer hover:bg-slate-200 transition">
                                ...
                                <button className="w-full bg-slate-800 hover:bg-slate-900 text-white font-bold py-3.5 rounded-xl transition mt-8 shadow-md">
                            ...
                            <div className="ab-logistics-card p-6 sm:p-8 flex flex-col h-full bg-gradient-to-br from-white to-blue-50/50">
                                ...
                                <div className="bg-white rounded-2xl border border-blue-100 shadow-sm p-5 mb-6 hover:border-blue-300 transition cursor-pointer">
                                ...
                                <button className="w-full ab-primary-btn !py-3.5 flex items-center justify-center gap-2 shadow-lg shadow-blue-500/20 !bg-blue-600 hover:!bg-blue-700">
